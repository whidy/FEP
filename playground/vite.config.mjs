...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      {
        find: /^@designable\/formily-elementplus/,
        replacement: resolve_path("../src"),
      },
      { find: /^~/, replacement: "" },
    ],
  },
  server: {
    ...
    proxy: {
      ...
      "/api": {
        target: process.env.NODE_ENV === "development" ? "http://localhost:8080" : "https://form-store.wodcloud.com",
        changeOrigin: true,
        secure: false,
      },
    },
